...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Pet List</h1>
        ...
        <div class="modal-dialog  modal-lg  modal-dialog-">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="petModelTitle">Add Pet</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating mb-4 floating">
                                        <input
                                            class="form-control pet_name" 
                                            id="pet_name"
                                            placeholder="Enter the pet name" 
                                            name="pet_name"
                                        >
                                        <label for="pet_name"><span class='text-danger'>*</span> Pet Name</label>
                                        <span class="error text-danger mt-5 pet_name"></span>
                                    </div>
                                </div>

                                <div class="col-lg-12 mt-3">
                                    <div>
                                        <label for="pet_img" class="form-label"><span class='text-danger'>*</span> Pet Image &nbsp;
                                    ...
                                    <img src="" id="pet_image_url" alt="image" width="130px" style="padding-top: 15px; display:none;">

                                    <span class="error text-danger pet_img mt-5"></span>
                                </div>
    ...
    <script src="<?= base_url() ?>assets/custom/js/pet.js"></script>
